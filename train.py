...
parser.add_argument('-lr', '--learning_rate', type=float, help='learning rate', default=0.1)
parser.add_argument('-m', '--momentum', type=float, help='Momentum used by momentum and nag optimizers', default=0.5)
parser.add_argument('-beta', '--beta', type=float, help='Beta used by rmsprop optimizer', default=0.5)
parser.add_argument('-beta1', '--beta1', type=float, help='used by adam and nadam optimizers', default=0.9)
parser.add_argument('-beta2', '--beta2', type=float, help='used by adam and nadam optimizers', default=0.999)
parser.add_argument('-eps', '--epsilon', type=float, help='Epsilon used by optimizers', default=0.000001)
parser.add_argument('-w_d', '--weight_decay', type=float, help='Weight decay used by optimizers', default=0.05)
